...
public:
    ...
    if (top) {
        const User& currentUser = top->user;
        cout << "User Info: " << currentUser.username << " | Age: " << currentUser.age << " | Balance: $" << fixed << setprecision(2) << currentUser.moneyBalance << "\n";
		} else {
...
try{
    ...
    do {
        ...
        cout << "3. Check Seats\n";
        cout << "4. Show Ticket\n";
        cout << "5. UserProfile (Display user info from file)\n";
        cout << "----------------------------------\n";
        cout << "------Developer Options Menu------\n";
        cout << "6. Add Movie\n";
        cout << "7. Edit Movie\n";
        cout << "8. Delete Movie\n";
        cout << "9. Sort the Movies (Alphabetic Order)\n";
        cout << "0. Exit\n";
...
// Function to show ticket from file
void showTicket() {
...
int main() {
    ...
    movieList.addMovie({"The Shawshank Redemption", 142, 100, 0, 9.3, "Drama", 10});
    movieList.addMovie({"Inception", 148, 120, 0, 8.8, "Sci-Fi", 12});
    movieList.addMovie({"The Dark Knight", 152, 150, 0, 9.0, "Action",5});
